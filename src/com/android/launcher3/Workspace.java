...
public class Workspace extends PagedView<WorkspacePageIndicator>
    ...
    public void removeExtraEmptyScreen(boolean stripEmptyScreens) {
        removeExtraEmptyScreenDelayed(null, 0, stripEmptyScreens);
    }

    public void removeExtraEmptyScreenDelayed(final Runnable onComplete,
        ...
        if (delay > 0) {
            postDelayed(() -> removeExtraEmptyScreenDelayed(onComplete, 0, stripEmptyScreens), delay);
            return;
        }
        ...
        if (d.dragSource != this || mDragInfo == null) {
            ...
            if (dropTargetLayout != null && !d.cancelled) {
                ...
                if (createUserFolderIfNecessary(cell, container,
                        ...
                        addToExistingFolderIfNecessary(dropTargetLayout, mTargetCell,
                                distance, d, false)) {
    ...
    public void onNoCellFound(View dropTargetLayout) {
        //Hotseat hotseat;
        //boolean droppedOnAllAppsIcon = false;
        // Only show message when hotseat is full and drop target was not AllApps button
        showOutOfSpaceMessage(mLauncher.isHotseatLayout(dropTargetLayout));
    }
