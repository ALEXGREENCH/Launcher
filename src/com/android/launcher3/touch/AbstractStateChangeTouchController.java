...
public abstract class AbstractStateChangeTouchController
    ...
    private AnimatorSet createAtomicAnimForState(LauncherState fromState, LauncherState targetState,
            long duration) {
        AnimatorSetBuilder builder = getAnimatorSetBuilderForStates();
    ...
    public void onDragEnd(float velocity, boolean fling) {
        ...
        updateSwipeCompleteAnimation(anim, Math.max(duration, getRemainingAtomicDuration()), velocity);
        mCurrentAnimation.dispatchOnStart();
    ...
    protected void updateSwipeCompleteAnimation(ValueAnimator animator, long expectedDuration, float velocity) {
